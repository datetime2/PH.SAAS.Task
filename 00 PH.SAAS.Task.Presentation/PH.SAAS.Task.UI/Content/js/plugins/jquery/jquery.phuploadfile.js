...
(function ($) {
	...
	var renderView = {
	    render: function (opts, container) {
	        //<label class="up-title-' + opts.headerWidth+ '" for="">' + opts.title + '</label>
			var html = [
                '<input class="hiddenImgSrc" type="hidden" value="' + opts.displayImgSrc + '" id= "' + opts.imgFieldName + '" name="' + opts.imgFieldName + '">',
                '<div class="up-file-' + opts.dataWidth + '"><input class="file uploadFilebtn ' + opts.isRequired + '" type="file" name="_file"  />',
